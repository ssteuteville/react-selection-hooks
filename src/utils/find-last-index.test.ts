...
describe('find last index', () => {
    ...
    describe('first item', () => {
        ...
        it('duplicates', () => {
            expect(findLastIndex(items, item => item === 1)).toEqual(uniqueItems.length);
        });
    });

    describe('last item', () => {
        it('unique', () => {
            expect(findLastIndex(uniqueItems, item => item === 7)).toEqual(uniqueItems.length - 1);
        });

        it('duplicates', () => {
            expect(findLastIndex(items, item => item === 7)).toEqual(items.length - 1);
        });
    });
    ...
    describe('middle item', () => {
        ...
        it('duplicates', () => {
            expect(findLastIndex(items, item => item === 4)).toEqual(uniqueItems.length + 3);
        });
    });
});